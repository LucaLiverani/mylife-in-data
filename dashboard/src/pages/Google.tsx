    ...
    return (
      <main className="min-h-screen bg-gradient-to-br from-rack-black to-rack-charcoal text-signal-white">
        <div className="mx-auto max-w-4xl px-6 py-20">
          <p className="text-trace-down">No calendar data yet. Calendar ingestion is still being wired up.</p>
        </div>
      </main>
    );
  }
        ...
        <FadeIn>
          ...
          <div className="mb-12">
            ...
            <p className="text-xl italic text-signal-white/60">
              Plans made, places to be. Negative space included.
            </p>
          </div>
        </FadeIn>

        <section className="mb-12" aria-labelledby="calendar-kpis">
          <FadeIn delay={0.1}>
              ...
              <div className="h-80">
                <ResponsiveContainer>
                  <LineChart data={dailyChart}>
                    ...
                    <XAxis dataKey="date" {...CHART_STYLES.timeSeriesXAxis} />
                    ...
                    <Line
                      ...
                      strokeWidth={2}
                      dot={{ fill: CHANNEL_HEX.calendar, r: 3 }}
                      activeDot={{ r: 5 }}
                    />
                  </LineChart>
                </ResponsiveContainer>
        ...
        <FadeIn delay={0.25}>
          <section className="mb-12 grid grid-cols-1 gap-6 lg:grid-cols-2" aria-labelledby="calendar-mix">
            <Surface>
              ...
              <ChannelPie channel="calendar" data={data.categories} height={280} topN={5} />
            </Surface>
                ...
                {data.upcomingEvents.map((e, i) => (
                  ...
                  >
                    ...
                    <div className="text-right font-mono text-xs">
                      <div className="text-channel-blue">{e.relativeTime}</div>
                      <div className="text-[10px] text-signal-white/50">{e.durationMinutes} min</div>
                    </div>
                  </li>
                ))}
              </ul>
