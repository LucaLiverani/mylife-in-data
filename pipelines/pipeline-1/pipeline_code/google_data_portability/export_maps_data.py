"""
Export Google Maps activity data using Google Data Portability API.

This script initiates an export job for Maps location history and activity,
...
def main():
    parser = argparse.ArgumentParser(
        description='Export Google Maps activity data via Data Portability API'
    )
    parser.add_argument(
        '--start-date',
    ...
    parser.add_argument(
        ...
        default='data/google_exports/maps',
        type=str
    )
    parser.add_argument(
        '--poll-interval',
    ...
    if not start_time and not end_time:
        print("No time filters specified - exporting ALL Maps activity data")

    print()

    # Initiate export
    print("Initiating Maps data export...")
    ...
    try:
        ...
        for idx, url in enumerate(urls, 1):
            filename = f"maps_data_part_{idx}.zip"
        ...
        print()
        print("=" * 60)
        print("✓ Maps data export complete!")
        print("=" * 60)
